...
func TestAccHashRingDataSource(t *testing.T) {
...
`,
					ConfigStateChecks: []statecheck.StateCheck{
						statecheck.ExpectKnownValue("data.hash_ring.test", tfjsonpath.New("mapping"), knownvalue.ObjectExact(map[string]knownvalue.Check{
