...
This project is a Terraform provider that adds hashing functionality. This provider is written in Go using the modern [`github.com/hashicorp/terraform-plugin-framework`](https://github.com/hashicorp/terraform-plugin-framework) ([docs](https://developer.hashicorp.com/terraform/plugin/framework)).
